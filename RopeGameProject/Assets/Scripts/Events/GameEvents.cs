public static class GameEvents
{
    ...
    public static void LevelSelected(int levelIndex) { OnLevelSelect?.Invoke(levelIndex); }
    public static void LevelDataLoaded(int amountOfLevels) { OnLevelDataLoad?.Invoke(amountOfLevels); }
    public static void ChooseLevel() { OnLevelChoose?.Invoke(); }
    public static void LevelStart() { OnLevelStart?.Invoke(); }
    public static void LevelWon() { OnLevelWin?.Invoke(); }
    public static void LevelExit() { OnLevelExit?.Invoke(); }
    public static void QuitGame() { OnQuitGame?.Invoke(); }
    public static void GemWasTouched(int gemID) { OnGemTouch?.Invoke(gemID); }
    public static void RopeReachedDestination() { OnRopeReachDestination?.Invoke(); }
    public static void BadLevelData() { OnBadLevelData?.Invoke(); }
}
